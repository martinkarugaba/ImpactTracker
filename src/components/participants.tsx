...
export default function Participants() {
  return (
    <div className="flex -space-x-[0.45rem]">
      ...
      <Button
        variant="outline"
        className="flex size-6 items-center justify-center rounded-full border-transparent text-xs text-muted-foreground/80 shadow-none ring-1 ring-background dark:border-transparent dark:bg-background dark:hover:bg-background"
        size="icon"
      >
