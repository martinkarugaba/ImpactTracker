...
export const vslaLoans = pgTable(
  "vsla_loans",
  {
    ...
    total_paid: integer("total_paid").notNull().default(0),
    balance_remaining: integer("balance_remaining").notNull(),
...
export const vslaLoanPayments = pgTable(
  "vsla_loan_payments",
  {
    ...
    notes: text("notes"),
    recorded_by: uuid("recorded_by").references(() => vslaMembers.id),
    created_at: timestamp("created_at").defaultNow(),
  },
  table => ({
...
export const vslaSavings = pgTable(
  "vsla_savings",
  {
    ...
    savings_type: text("savings_type").notNull().default("regular"),
...
export const vslaMeetings = pgTable(
  "vsla_meetings",
  {
    ...
    meeting_type: text("meeting_type").notNull().default("regular"),
    ...
    notes: text("notes"),
    conducted_by: uuid("conducted_by").references(() => vslaMembers.id),
...
export const vslaMeetingAttendance = pgTable(
  "vsla_meeting_attendance",
  {
    ...
    member_id: uuid("member_id")
      .references(() => vslaMembers.id)
      .notNull(),
    attendance_status: text("attendance_status").notNull().default("present"),
...
// Meeting financial transactions
