    ...
    <div className="flex w-full items-center justify-center px-4 sm:px-6 md:px-8 lg:px-10">
      <div className="w-full max-w-7xl">
        <div className="@container">
          <div className="flex flex-col items-center justify-center gap-6 py-10 text-center @[480px]:gap-8 @[480px]:py-20">
            <div className="flex max-w-[720px] flex-col gap-4">
              ...
              <p className="text-base leading-relaxed font-normal text-[#0e151b]">
